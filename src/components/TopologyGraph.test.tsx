...
import { REVIEW_CHALENGE_END_LABEL, REVIEW_CHALENGE_LABEL } from "@shared/review-response";
...
test("TopologyGraph 历史记录会去掉 chalenge 标签", () => {
  const html = getTopologyHtml([
    {
      id: "message-1",
      projectId: "project-1",
  ...
  assert.doesNotMatch(html, /&lt;chalenge&gt;/);
  assert.doesNotMatch(html, /&lt;\/chalenge&gt;/);
});
