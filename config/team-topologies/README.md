...
[
  ...
  { "from": "Build", "to": "CodeReview", "trigger_type": "handoff", "message_type": "last" },
  { "from": "CodeReview", "to": "Build", "trigger_type": "action_required", "message_type": "last" }
]
```
...
```json
{
  ...
  "links": [
    { "from": "BA", "to": "Build", "trigger_type": "handoff", "message_type": "last" },
    { "from": "Build", "to": "CodeReview", "trigger_type": "handoff", "message_type": "last" },
    { "from": "Build", "to": "UnitTest", "trigger_type": "handoff", "message_type": "last" },
    { "from": "Build", "to": "TaskReview", "trigger_type": "handoff", "message_type": "last" },
    { "from": "CodeReview", "to": "Build", "trigger_type": "action_required", "message_type": "last" },
    { "from": "UnitTest", "to": "Build", "trigger_type": "action_required", "message_type": "last" },
    { "from": "TaskReview", "to": "Build", "trigger_type": "action_required", "message_type": "last" }
  ]
}
```
...
- 根图写的是 `{ "from": "疑点辩论", "to": "初筛", "trigger_type": "handoff", "message_type": "none" }`，因此 `裁决总结` 完成本轮裁决后，会按 `handoff` 触发 `初筛` 继续寻找下一个 finding
